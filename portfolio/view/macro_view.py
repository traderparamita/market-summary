"""Macro asset-allocation view — View Agent deliverable.

Current-state macro view combining:
...
def compute_macro_view(date: str, csv_path: str | Path | None = None) -> dict:
...
<title>Macro Asset Allocation View | {report_date}</title>
<style>
...
<div class="header">
  <div>
    <h1>Macro Asset Allocation View</h1>
    <div class="meta">Current-state view | View Agent</div>
  </div>
  <div class="gen">
...
<div class="footer">Macro Asset Allocation View | TAA Regime Reference + Asset-Class Views | View Agent</div>
...
def main():
    parser = argparse.ArgumentParser(description="Macro asset-allocation view")
    ...
    print(f"\n{'='*55}")
    print(f"  Macro View as of {view['date']}")
    print(f"{'='*55}")
