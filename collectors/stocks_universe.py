...
ASIA_TOP: list[tuple[str, str, str, int, str, str]] = [
    ...
    # === asia-weekly 커버리지 보강 (2026-07-25) — 미매칭 47종목 추가 ============================
    # 출처: history/아시아종목.xlsx 유니버스. 이전 130종목 외 미수집분(대부분 xlsx 티커 nan) 보강.
    # yfinance 실증 검증 완료(2026-07-24 종가 확인). 3번째 필드(ticker_name)=xlsx name 정확일치(매칭키).
    # 디머저/신규상장: Tata Motors=TMPV.NS · Aditya Infotech=CPPLUS.NS · MiniMax=0100.HK(2026-01 상장) · Orient Overseas=0316.HK.
    ("ST_AS_ABB_NS",          "ABB.NS",        "ABB India",                 666, "India", "ABB India"),
    ("ST_AS_CPPLUS_NS",       "CPPLUS.NS",     "Aditya Infotech",           667, "India", "Aditya Infotech (CP Plus)"),
    ("ST_AS_CGPOWER_NS",      "CGPOWER.NS",    "CG Power & Industrial",     668, "India", "CG Power and Industrial Solutions"),
    ("ST_AS_HINDALCO_NS",     "HINDALCO.NS",   "Hindalco Industries",       669, "India", "Hindalco Industries"),
    ("ST_AS_JSWSTEEL_NS",     "JSWSTEEL.NS",   "JSW Steel",                 670, "India", "JSW Steel"),
    ("ST_AS_PIDILITIND_NS",   "PIDILITIND.NS", "Pidilite Industries",       671, "India", "Pidilite Industries"),
    ("ST_AS_TMPV_NS",         "TMPV.NS",       "Tata Motors",               672, "India", "Tata Motors Passenger Vehicles"),
    ("ST_AS_VMM_NS",          "VMM.NS",        "Vishal Mega Mart",          673, "India", "Vishal Mega Mart"),
    ("ST_AS_6770_T",          "6770.T",        "Alps Alpine",               674, "Japan", "Alps Alpine"),
    ("ST_AS_5803_T",          "5803.T",        "Fujikura",                  675, "Japan", "Fujikura"),
    ("ST_AS_6856_T",          "6856.T",        "Horiba",                    676, "Japan", "Horiba"),
    ("ST_AS_3132_T",          "3132.T",        "Macnica Holdings",          677, "Japan", "Macnica Holdings"),
    ("ST_AS_6871_T",          "6871.T",        "Micronics Japan",           678, "Japan", "Micronics Japan"),
    ("ST_AS_6323_T",          "6323.T",        "RORZE",                     679, "Japan", "RORZE"),
    ("ST_AS_268A_T",          "268A.T",        "Rigaku Holdings",           680, "Japan", "Rigaku Holdings"),
    ("ST_AS_6590_T",          "6590.T",        "Shibaura Mechatronics",     681, "Japan", "Shibaura Mechatronics"),
    ("ST_AS_6526_T",          "6526.T",        "Socionext",                 682, "Japan", "Socionext"),
    ("ST_AS_5357_T",          "5357.T",        "Tekscend Photomask",        683, "Japan", "Tekscend Photomask"),
    ("ST_AS_7729_T",          "7729.T",        "Tokyo Seimitsu",            684, "Japan", "Tokyo Seimitsu"),
    ("ST_AS_6728_T",          "6728.T",        "ULVAC",                     685, "Japan", "ULVAC"),
    ("ST_AS_6160_HK",         "6160.HK",       "BeOne Medicines",           686, "China", "BeOne Medicines (BeiGene)"),
    ("ST_AS_1908_HK",         "1908.HK",       "C&D International Investment", 687, "China", "C&D International Investment"),
    ("ST_AS_0883_HK",         "0883.HK",       "CNOOC",                     688, "China", "CNOOC"),
    ("ST_AS_1919_HK",         "1919.HK",       "COSCO Shipping H",          689, "China", "COSCO Shipping Holdings"),
    ("ST_AS_0257_HK",         "0257.HK",       "China Everbright Environment", 690, "China", "China Everbright Environment"),
    ("ST_AS_1378_HK",         "1378.HK",       "China Hongqiao Group",      691, "China", "China Hongqiao Group"),
    ("ST_AS_1088_HK",         "1088.HK",       "China Shenhua Energy H",    692, "China", "China Shenhua Energy"),
    ("ST_AS_3360_HK",         "3360.HK",       "Far East Horizon",          693, "China", "Far East Horizon"),
    ("ST_AS_0148_HK",         "0148.HK",       "Kingboard Holdings",        694, "China", "Kingboard Holdings"),
    ("ST_AS_688787_SS",       "688787.SS",     "Knowledge Atlas",           695, "China", "Knowledge Atlas"),
    ("ST_AS_0100_HK",         "0100.HK",       "MiniMax",                   696, "China", "MiniMax Group"),
    ("ST_AS_0857_HK",         "0857.HK",       "PetroChina H",              697, "China", "PetroChina"),
    ("ST_AS_301021_SZ",       "301021.SZ",     "RoboTechnik Intelligent",   698, "China", "RoboTechnik Intelligent Technology"),
    ("ST_AS_1308_HK",         "1308.HK",       "SITC International",         699, "China", "SITC International Holdings"),
    ("ST_AS_688777_SS",       "688777.SS",     "SUPCON Technology",         700, "China", "SUPCON Technology"),
    ("ST_AS_688188_SS",       "688188.SS",     "Shanghai BOCHU Electronic", 701, "China", "Shanghai BOCHU Electronic"),
    ("ST_AS_0288_HK",         "0288.HK",       "WH Group",                  702, "China", "WH Group"),
    ("ST_AS_300567_SZ",       "300567.SZ",     "Wuhan Jingce Electronic",   703, "China", "Wuhan Jingce Electronic Group"),
    ("ST_AS_1171_HK",         "1171.HK",       "Yankuang Energy H",         704, "China", "Yankuang Energy Group"),
    ("ST_AS_0101_HK",         "0101.HK",       "Hang Lung Properties",      705, "HK", "Hang Lung Properties"),
    ("ST_AS_0012_HK",         "0012.HK",       "Henderson Land",            706, "HK", "Henderson Land Development"),
    ("ST_AS_0014_HK",         "0014.HK",       "Hysan Development",         707, "HK", "Hysan Development"),
    ("ST_AS_0683_HK",         "0683.HK",       "Kerry Properties",          708, "HK", "Kerry Properties"),
    ("ST_AS_0316_HK",         "0316.HK",       "Orient Overseas",           709, "HK", "Orient Overseas International"),
    ("ST_AS_0083_HK",         "0083.HK",       "Sino Land",                 710, "HK", "Sino Land"),
    ("ST_AS_0303_HK",         "0303.HK",       "VTech Holdings",            711, "HK", "VTech Holdings"),
    ("ST_AS_0551_HK",         "0551.HK",       "Yue Yuen Industrial",       712, "HK", "Yue Yuen Industrial"),
]
